<template>
  <div>
          ...
          <div class="banner-tabs">
            <div class="tab-outr">
              <TabWrapper>
                ...
                <template v-if="common.state.is_webtoon_display">
                ...
                <template v-if="common.state.is_webtoon_display">
                  <Tabs title="header.mainMenu.Webtoons">
                    <div class="lists tab-scroll" v-if="webtoon_trending.length > 0">
                      ...
                      <a @click="$router.push('/webtoons/going')" class="more-content">
                        <img src="../assets/icons/right-arrow-solid.svg" alt="more" class="white-image" />
                        <img src="../assets/icons/solid-right-arrow.svg" alt="more" class="red-image" />
                      </a>
                    </div>
        ...
        <div class="hot-lists">
          ...
          <div class="hot-content" v-if="hot_videos.length > 0">
            <div class="lists tab-scroll">
              ...
              <a @click="$router.push('/video/popular')" class="more-content"
                v-if="hot_videos.length > 3 && common.state.is_video_display">
                <img src="../assets/icons/right-arrow-solid.svg" alt="more" class="white-image" />
                <img src="../assets/icons/solid-right-arrow.svg" alt="more" class="red-image" />
              </a>
            </div>
    ...
    <section class="common-section coming-soon common-shows" :class="latest_trailers.length > 0 ? '' : 'pb-0'"
      v-show="movies_coming_soon?.length > 0 || tv_show_coming_soon?.length > 0">
      <div class="container">
        <div class="trending-content">
      ...
      <div class="container">
        <div class="hot-lists">
          ...
          <div class="hot-content" v-if="latest_trailers.length > 0">
            ...
            <a @click="$router.push('/video/trailer')" class="more-content"
              v-if="latest_trailers.length > 3 && common.state.is_video_display">
              <img src="../assets/icons/right-arrow-solid.svg" alt="more" class="white-image" />
              <img src="../assets/icons/solid-right-arrow.svg" alt="more" class="red-image" />
            </a>
          </div>
                ...
                <Tabs title="header.mainMenu.Movies">
                  <div class="lists tab-scroll" v-if="movies_popular?.length > 0">
                    <div class="outerside">
                      ...
                      RedirectLink="MoviesDetails" type="movie" section="popular" />
                    </div>
                ...
                <Tabs title="header.mainMenu.TVShows">
                  <div class="lists tab-scroll" v-if="tv_show_popular?.length > 0">
                    <div class="outerside">
                      ...
                      RedirectLink="TvShowsDetails" type="tv" section="popular" />
                    </div>
                  ...
                  <Tabs title="header.mainMenu.Webtoons">
                    <div class="lists tab-scroll" v-if="webtoon_popular?.length > 0">
                      <div class="outerside">
                        ...
                        RedirectLink="WebtoonsDetail" type="tv" section="popular"
                ...
                <Tabs title="header.mainMenu.Movies">
                  <div class="lists tab-scroll" v-if="movie_new_release?.length > 0">
                    <div class="outerside">
                      ...
                      RedirectLink="MoviesDetails" type="movie" section="newrelease" />
                    </div>
                ...
                <Tabs title="header.mainMenu.TVShows">
                  <div class="lists tab-scroll" v-if="tv_show_new_release?.length > 0">
                    <div class="outerside">
                      ...
                      RedirectLink="TvShowsDetails" type="tv" section="newrelease" />
                    </div>
                  ...
                  <Tabs title="header.mainMenu.Webtoons">
                    <div class="lists tab-scroll" v-if="webtoon_new_realease?.length > 0">
                      <div class="outerside">
                        ...
                        RedirectLink="WebtoonsDetail" type="webtoons" section="newrelease" />
                      </div>
